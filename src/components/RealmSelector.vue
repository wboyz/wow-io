...
<template>
  <label for="realm" class="relative input input-bordered flex items-center gap-2">
    ...
    <ul class="absolute z-10 w-full bg-white border border-gray-300 rounded-md shadow-lg overflow-y-auto top-12 left-0"
      ...
      <li v-for="option in filteredRealms" :key="option.slug" @click="selectOption(option)"
